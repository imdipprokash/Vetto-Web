const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "You must notify us immediately at support@vettocloud.com if you suspect unauthorised use of your account.",
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-5 sm:px-8">
          <p className="text-gray-500 text-lg leading-relaxed mb-14 pb-14 border-b border-gray-100">
            Please read these Terms of Use carefully before using Vetto. They
            form a binding agreement between you and Vetto regarding your use of
          ...
          <div className="mt-16 pt-10 border-t border-gray-100 text-center">
            ...
            <p className="text-gray-500 text-sm mb-6">
              For questions about these Terms, reach out — we aim to respond
