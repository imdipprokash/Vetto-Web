...
const steps = [
  { step: '01', title: 'Create your account', desc: 'Sign up free with email or Google in under a minute.' },
  { step: '02', title: 'Add your pets', desc: 'Build a profile for each pet with photo, breed, and birthday.' },
  { step: '03', title: 'Log health records', desc: 'Track visits, vaccines, meds, and weight from one dashboard.' },
  { step: '04', title: 'Get smart reminders', desc: 'Push notifications ensure nothing slips through the cracks.' },
]
          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-gray-500 text-lg md:text-xl max-w-md mx-auto md:mx-0 mb-10 leading-relaxed">
                Vetto is the all-in-one health manager for your furry, feathered, and scaly family. Track records, set reminders, and share with your vet — effortlessly.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                <a href="#download" className="btn-secondary gap-2.5 py-3.5 px-7 text-base">
                  <PlayIcon />
                  Google Play
                </a>
              </div>
            ...
            <div className="flex-shrink-0 relative">
              <div className="relative w-56 h-56 md:w-64 md:h-64">
                <div className="w-full h-full rounded-[2.5rem] overflow-hidden shadow-2xl ring-1 ring-black/5">
                  <img src="/icon.png" alt="Vetto App" className="w-full h-full object-cover" />
                </div>
                {/* Floating badge */}
                <div className="absolute -bottom-5 -left-8 bg-white rounded-2xl px-4 py-3 shadow-xl ring-1 ring-black/5 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-400 leading-none mb-0.5">Trusted by</p>
                    <p className="text-sm font-semibold text-gray-800">Pet Owners</p>
                  </div>
                </div>
                {/* Floating badge 2 */}
                <div className="absolute -top-5 -right-6 bg-white rounded-2xl px-4 py-3 shadow-xl ring-1 ring-black/5 flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-xs text-gray-400 leading-none mb-0.5">Records</p>
                    <p className="text-sm font-semibold text-gray-800">Up-to-date</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          <div className="max-w-xl mb-14">
            ...
            <p className="mt-4 text-gray-500 text-lg leading-relaxed">
              From first vaccines to senior care, Vetto covers every chapter of your pet's health story.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {steps.map(({ step, title, desc }) => (
              <div key={step} className="flex flex-col">
                <span className="font-serif text-6xl text-brand-200 leading-none mb-4">{step}</span>
      ...
      <section id="download" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          <div className="bg-brand-500 rounded-3xl px-8 py-16 md:px-16 flex flex-col md:flex-row items-center gap-10">
            <div className="flex-1 text-center md:text-left">
              <span className="text-brand-200 text-xs font-semibold uppercase tracking-widest mb-4 block">Free download</span>
              ...
              <p className="text-brand-100 text-lg mb-8 max-w-md">
                Join thousands of pet owners keeping their companions healthy and happy. Available now on Android.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                <a
                  href="#"
                ...
                >
                  <PlayIcon />
                  <span>
                    <span className="block text-[10px] font-normal text-gray-500 text-left leading-none">Get it on</span>
            ...
            <div className="flex-shrink-0">
              <div className="w-36 h-36 md:w-44 md:h-44 rounded-[2rem] overflow-hidden shadow-2xl ring-4 ring-white/20">
                <img src="/icon.png" alt="Vetto" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
          <p className="mt-6 text-center text-gray-400 text-sm">
            Questions?{' '}
            <a href="mailto:support@vetto.org" className="text-brand-600 hover:underline">
              support@vetto.org
            </a>
          </p>
        </div>
