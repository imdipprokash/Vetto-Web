const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      'Despite our efforts, no system is completely immune to security risks. Please use a strong, unique password and report any suspected vulnerability to support@vetto.org.',
    ],
  },
  {
    title: 'Your rights',
  ...
  },
  {
    ...
    content: [
      'Vetto is not directed to children under 13 (or under 16 in the EEA). We do not knowingly collect personal information from children. If you believe a child has provided us with personal information, please contact us at support@vetto.org.',
    ],
  },
  {
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#F7FAF7] py-24">
        <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center">
          ...
          <h1 className="font-serif text-5xl sm:text-6xl text-gray-900 leading-tight mb-5">Privacy Policy</h1>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-5 sm:px-8">
          <p className="text-gray-500 text-lg leading-relaxed mb-14 pb-14 border-b border-gray-100">
            Vetto ("we", "our", "us") is committed to protecting your privacy. This Privacy Policy explains what information we collect, how we use it, and the choices you have. By using Vetto, you agree to the practices described here.
          </p>
          ...
          <div className="mt-16 pt-10 border-t border-gray-100 text-center">
            ...
            <p className="text-gray-500 text-sm mb-6">If you have concerns about this policy or how we handle your data, reach out — we aim to respond within 48 hours.</p>
